...
Android-приложение строится отдельно на базе закреплённого NagramX 1258. CI получает полный Android upstream, применяет `android/apply_overlay.py` и собирает APK; Android-код не связывается с приложением для iOS.
