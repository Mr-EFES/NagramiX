...
/** Product metadata helpers shared by the native Android profile surfaces. */
public final class NagramiXPeerMetadata {
    private NagramiXPeerMetadata() {}

    /**
     * Telegram does not expose a registration timestamp. Keep the estimate
     * deliberately broad and aligned with the iOS implementation.
     */
