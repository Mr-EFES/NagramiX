...
def main() -> None:
    ...
    replace_exact(
        ...
        "    public static boolean isNagramiXCopySupported(MessageObject message) {\n"
        ...
        "        return message != null && (text || media) && !message.isEphemeral() && !message.messageOwner.noforwards\n"
        ...
        "            if (!isNagramiXCopySupported(message)) {\n"
        "                return 1;\n"
        "            }\n"
        "        }\n"
...
"""
    ...
    replace_exact(
        ...
        "                    options.add(OPTION_FORWARD);\n"
        "                    icons.add(R.drawable.msg_forward);\n"
        "                    if (SendMessagesHelper.isNagramiXCopySupported(selectedObject)) {\n"
