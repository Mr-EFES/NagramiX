...
| `interface.wideChannelPosts` | `false` | Interface / Chats | Force every broadcast-channel post, including media mosaics, to the maximum safe width. |
...
| `profiles.showMutualContactIcon` | `false` | Interface / Profiles | Mark real mutual contacts in their profile and supported contact rows. |
