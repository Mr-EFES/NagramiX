...
## Текущая версия в разработке: 0.2.8
...
Нативная ARM64-сборка iOS 0.2.8, упаковка unsigned IPA и публикация прошли в GitHub Actions. Русский clean-install flow, тёмная тема и максимальная ширина постов ещё требуют проверки на физическом iPhone.
