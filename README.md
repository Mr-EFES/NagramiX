...
Нативная ARM64-сборка iOS 0.3.5, проверка русских строк внутри собранного приложения, упаковка unsigned IPA и публикация прошли в GitHub Actions. Исправленная геометрия широких постов ожидает runtime-приёмку на физическом iPhone.
