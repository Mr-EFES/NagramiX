...
## Текущая версия в разработке: 0.3.5
...
Версия 0.3.5 подготовлена к нативной ARM64-сборке iOS в GitHub Actions. Проверка русских строк внутри собранного приложения, упаковка unsigned IPA и публикация должны пройти до выдачи артефакта; runtime-приёмка на физическом iPhone остаётся отдельным этапом.
