...
## Актуальная версия: 0.3.7

**0.3.7 — почти стабильная базовая версия проекта.** Все дальнейшие изменения
разрабатываются поверх неё; устаревшие версии и их release-файлы в рабочем
дереве не хранятся.
...
Версия 0.3.7 закреплена как единственная актуальная линия NagramiX. Нативная
ARM64-сборка и упаковка unsigned IPA успешно прошли в GitHub Actions. Перед
окончательным стабильным релизом остаётся полный runtime-регресс на физическом iPhone.
