...
## Текущая версия в разработке: 0.3.4
...
Нативная ARM64-сборка iOS 0.3.3, проверка русских строк внутри собранного приложения, упаковка unsigned IPA и публикация прошли в GitHub Actions. Версия 0.3.4 сохраняет принятый функционал и переносит усиленные проверки широких постов в новый физический тест; компиляция не заменяет приёмку на iPhone.
