...
## Текущая версия в разработке: 0.3.6
...
Версия 0.3.6 основана на работоспособной 0.3.4 и изменяет только финальную ширину одиночных фото и видео в широких постах каналов. Версия 0.3.5 признана неработоспособной и не должна использоваться. Нативная ARM64-сборка, упаковка и публикация 0.3.6 прошли; физическая проверка на iPhone ещё требуется.
