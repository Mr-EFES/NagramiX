...
Исправления iOS 0.2.8 подготовлены к нативной ARM64-сборке в GitHub Actions. Русский clean-install flow, тёмная тема и максимальная ширина постов ещё требуют проверки на физическом iPhone.
