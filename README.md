...
## Текущая версия в разработке: 0.2.9
...
Нативная ARM64-сборка iOS 0.2.9, проверка русских строк внутри собранного приложения, упаковка unsigned IPA и публикация прошли в GitHub Actions. Предыдущая 0.2.8 показывала ключи `Tour.*` и не должна использоваться; runtime-приёмка 0.2.9 на физическом iPhone ещё требуется.
