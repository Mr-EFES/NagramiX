...
Исправление стартового экрана iOS 0.2.9 подготовлено к нативной ARM64-сборке. Предыдущая 0.2.8 показывала ключи `Tour.*` вместо русских строк и не должна использоваться для приёмки. Новый IPA ещё требует сборки и проверки на физическом iPhone.
