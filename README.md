...
## Текущая версия в разработке: 0.3.7
...
Версия 0.3.7 исправляет ширину текстовых постов каналов: после нативного расчёта текста внешний пузырь получает максимальную безопасную ширину. Геометрия одиночных фото, видео и альбомов остаётся на ветке 0.3.6. Компиляция 0.3.7 до прохождения macOS/Xcode workflow не заявлена.
