...
Версия 0.3.6 основана на работоспособной 0.3.4 и изменяет только финальную ширину одиночных фото и видео в широких постах каналов. Версия 0.3.5 признана неработоспособной и не должна использоваться. Нативная сборка и физическая проверка 0.3.6 ещё требуются.
